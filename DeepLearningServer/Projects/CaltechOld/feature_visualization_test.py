...
EXPORTPATH = 'FeatureVisualizationExampleImages'
EXPORTINTERVAL = 50
EPOCHS = 200
...
module_list = ["embedded_model.layer2.0.tracker1", "embedded_model.layer3.0.tracker1"]; parameters['module_list'] = module_list
