...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_Scanner p_Scanner;
        ...
        public static SteamVR_Input_ActionSet_Scanner Scanner
        {
            get
            {
                return SteamVR_Actions.p_Scanner.GetCopy<SteamVR_Input_ActionSet_Scanner>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_Scanner = ((SteamVR_Input_ActionSet_Scanner)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_Scanner>("/actions/Scanner")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.Scanner};
        }
    }
}
